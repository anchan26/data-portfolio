      ...
      <section className="max-w-4xl mx-auto px-6 mb-32">
        ...
        <div className="space-y-16">
          {[
            ...
            { label: "Analytics", items: stack.analytics },
            { label: "AI & LLM Production", items: stack.aiAndLLMs },
            ...
            <div key={cat.label}>
              ...
              <div className="flex flex-wrap gap-3">
                {cat.items.map((item) => (
                  <div key={item} className="flex items-center gap-2 bg-white border border-gray-200 px-5 py-2.5 rounded-full shadow-sm hover:shadow-md transition-shadow cursor-default">
